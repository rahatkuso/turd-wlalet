...
export class Backend {
    ...
    init(config) {
        ...
        if(os.platform() == "win32") {
	        this.config_dir = "C:\\ProgramData\\turd";
	    //this.config_dir = path.join(os.homedir(), "turd");
        } else {
            this.config_dir = path.join(os.homedir(), ".turd");
        }
    ...
    handle(data) {
        ...
        switch (data.method) {
            ...
            case "open_explorer":
                if(params.type == "tx") {
                    require("electron").shell.openExternal("https://explorer.turd-currency.com/tx/"+params.id)
                }
                break;
