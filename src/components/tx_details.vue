            ...
            <div class="row justify-between" style="max-width: 768px">
                ...
                <div class="infoBox">
                    <div class="infoBoxContent">
                        ...
                        <div class="value"><span><FormatTurd :amount="tx.amount" /></span></div>
                    </div>
                </div>
                ...
                <div class="infoBox">
                    <div class="infoBoxContent">
                        ...
                        <div class="value"><span><FormatTurd :amount="tx.fee" /></span></div>
                    </div>
                </div>
                    ...
                    <template v-if="out_destinations">
                        <q-item class="q-px-none" v-for="destination in out_destinations">
                            ...
                            <q-item-main>
                                ...
                                <q-item-tile sublabel><FormatTurd :amount="destination.amount" /></q-item-tile>
                            </q-item-main>
                        </q-item>
                    </template>
                    <template v-else>
...
import FormatTurd from "components/format_turd"
export default {
    name: "TxDetails",
    computed: mapState({
