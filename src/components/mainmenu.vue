...
<div>
        ...
        <q-popover>
            <q-list separator link>
                ...
                <q-item v-close-overlay @click.native="exit">
                    <q-item-main>
                        <q-item-tile label>Exit Turd GUI Wallet</q-item-tile>
                    </q-item-main>
                </q-item>
            </q-list>
        </q-popover>
    ...
    <q-modal minimized ref="aboutModal">
        <div class="about-modal">
            ...
            <img class="q-mb-md" src="statics/turd-wallet.svg" height="42" />

            <p class="q-my-sm">Version: ATOM v1.0.2-0.3.1.2</p>
            <p class="q-my-sm">Copyright (c) 2018, Turd Currency Project</p>
            <p class="q-my-sm">All rights reserved.</p>

            <div class="q-mt-md q-mb-lg external-links">
                <p>
                    <a @click="openExternal('https://turd-currency.com/')" href="#">https://turd-currency.com/</a>
                </p>
                <p>
                    <a @click="openExternal('https://t.me/turdcurrency')" href="#">Telegram</a> -
                    <a @click="openExternal('https://discord.gg/GFQmFtx')" href="#">Discord</a> -
                    <a @click="openExternal('https://www.reddit.com/r/turdcurrency/')" href="#">Reddit</a>
                </p>
            </div>
